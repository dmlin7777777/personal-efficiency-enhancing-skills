...
## Interview Readiness / 面试追问预演

> 针对 🔴 Major 级别审计问题生成的预期追问，帮助你在面试前做好准备。
> Generated for 🔴 Major issues to help you prepare before the interview.

| # | Resume Wording / 简历措辞 | Expected Interview Question / 预期追问 | Preparation Suggestion / 准备建议 |
|------|------|------|------|
| 1 | "Led cross-functional team of 15" | "Could you walk me through the biggest resource conflict you faced leading this team and how you resolved it?" / "请描述你主导时遇到的最大资源冲突及解决方法" | Prepare STAR: Situation (team composition conflict) → Task (alignment goal) → Action (stakeholder mapping) → Result (delivered on time) |
| 2 | "Architected real-time data pipeline" | "What were the key trade-offs you considered? Why this architecture over alternatives?" / "你考虑了哪些关键权衡？为什么选这个架构？" | Prepare: 2-3 alternatives considered, why rejected, measurable outcome of chosen approach |
