...
# ─── URL & Portfolio patterns ─────────────
# Known portfolio / professional link domains
LINK_PATTERNS = {
...
# Role type detection (structural keyword matching)
ROLE_LINK_MAP = {
...
def detect_role_type(jd_text: str) -> list:
    ...
    Returns list of matched role type keys.
    """
    matched = []
...
def scan_resume_links(resume_text: str) -> list:
    ...
    Returns list of {"type": "...", "url": "..."} dicts.
    """
    found = []
    seen_types = set()
...
def check_portfolio_links(jd_text: str, resume_text: str) -> dict:
    ...
    Returns {"role_types": [...], "links_found": [...], "missing_critical": bool, "missing_links": [...]}.
    """
